...
class AgnosticCollection(AgnosticBaseProperties[_DocumentType]):
    ...
    def find_raw_batches(self, *args: Any, **kwargs: Any) -> AgnosticRawBatchCursor[_DocumentType]: ...
    def aggregate(
        self, pipeline: _Pipeline, *args: Any, **kwargs: Any
    ) -> AgnosticCommandCursor[_DocumentType]: ...
...
class AgnosticBaseCursor(AgnosticBase, Generic[_DocumentType]):
    def __init__(
        self, cursor: Union[Cursor[_DocumentType], CommandCursor[_DocumentType], _LatentCursor[_DocumentType]], collection: AgnosticCollection[_DocumentType]
    ) -> None: ...
...
class AgnosticCursor(AgnosticBaseCursor[_DocumentType]):
    ...
    def max_await_time_ms(self, max_await_time_ms: Optional[int]) -> AgnosticCursor[_DocumentType]: ...
...
class AgnosticLatentCommandCursor(AgnosticCommandCursor[_DocumentType]):
    __motor_class_name__: str
    def __init__(self, collection: AgnosticCollection[_DocumentType], start: Any, *args: Any, **kwargs: Any): ...
